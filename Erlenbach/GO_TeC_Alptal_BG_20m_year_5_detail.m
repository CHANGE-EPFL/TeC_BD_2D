...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
dateNum1 = datenum(2015, 10, 1, 0, 0, 0);
dateNum2 = datenum(2016, 9, 30, 23, 0, 0);
...
for t=2:N_time_step
    ...
    if t == 2
        ...
        % load the variables from the last time step
         if Opt_hot==1
            % load('D:\Taiqi\Alp_var_ice_noRF\Ac_BG_Alp_4\Final_step_Ac_BG_Alp_4_8759.mat')
            load([pwd filesep 'Ac_BG_Alp_4' filesep 'Final_step_Ac_BG_Alp_4_8759.mat']);
            t=2;
            TITLE_SAVE = 'Ac_BG_Alp_5';
dateNum1 = datenum(2015, 10, 1, 0, 0, 0);
dateNum2 = datenum(2016, 9, 30, 23, 0, 0);
