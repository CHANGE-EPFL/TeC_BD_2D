...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
dateNum1 = datenum(2018, 10, 1, 0, 0, 0);
dateNum2 = datenum(2019, 9, 30, 23, 0, 0);
...
for t=2:N_time_step
    ...
    if t == 2
        ...
        % load the variables from the last time step
         if Opt_hot==1
            % load('D:\Taiqi\Alp_var_ice_noRF\Ac_BG_Alp_7\Final_step_Ac_BG_Alp_7_8759.mat')
            load([pwd filesep 'Ac_BG_Alp_7' filesep 'Final_step_Ac_BG_Alp_7_8759.mat']);
            t=2;
            TITLE_SAVE = 'Ac_BG_Alp_8';
dateNum1 = datenum(2018, 10, 1, 0, 0, 0);
dateNum2 = datenum(2019, 9, 30, 23, 0, 0);
