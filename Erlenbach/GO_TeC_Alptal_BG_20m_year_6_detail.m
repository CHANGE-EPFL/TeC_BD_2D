...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
dateNum1 = datenum(2016, 10, 1, 0, 0, 0);
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if t == 2
        ...
        % load the variables from the last time step
         if Opt_hot==1
            % load('D:\Taiqi\Alp_var_ice_noRF\Ac_BG_Alp_5\Final_step_Ac_BG_Alp_5_8783.mat')
            load([pwd filesep 'Ac_BG_Alp_5' filesep 'Final_step_Ac_BG_Alp_5_8783.mat']);
            t=2;
            TITLE_SAVE = 'Ac_BG_Alp_6';
dateNum1 = datenum(2016, 10, 1, 0, 0, 0);
dateNum2 = datenum(2017, 9, 30, 23, 0, 0);
