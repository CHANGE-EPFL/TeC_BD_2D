...
dateNum1 = datenum(2012, 10, 1, 0, 0, 0);
dateNum2 = datenum(2013, 9, 30, 23, 0, 0);
...
for t=2:N_time_step
    ...
    if t == 2
        ...
        % load the variables from the last time step
         if Opt_hot==1
            % load('D:\Taiqi\Alp_var_ice_noRF\Ac_BG_Alp_1\Final_step_Ac_BG_Alp_1_8783.mat')
            load([pwd filesep 'Ac_BG_Alp_1' filesep 'Final_step_Ac_BG_Alp_1_8783.mat']);
