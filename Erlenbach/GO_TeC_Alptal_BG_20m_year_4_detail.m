...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
dateNum1 = datenum(2014, 10, 1, 0, 0, 0);
dateNum2 = datenum(2015, 9, 30, 23, 0, 0);
...
for t=2:N_time_step
    ...
    if t == 2
        ...
        % load the variables from the last time step
         if Opt_hot==1
            % load('D:\Taiqi\Alp_var_ice_noRF\Ac_BG_Alp_3\Final_step_Ac_BG_Alp_3_8759.mat')
            load([pwd filesep 'Ac_BG_Alp_3' filesep 'Final_step_Ac_BG_Alp_3_8759.mat']);
            t=2;
            TITLE_SAVE = 'Ac_BG_Alp_4';
dateNum1 = datenum(2014, 10, 1, 0, 0, 0);
dateNum2 = datenum(2015, 9, 30, 23, 0, 0);
