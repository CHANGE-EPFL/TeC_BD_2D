...
dateNum1 = datenum(2004, 10, 1, 0, 0, 0);
dateNum2 = datenum(2005, 9, 30, 23, 0, 0);
...
for t=2:N_time_step
    ...
    if t == 2
        ...
        if Opt_hot==1
            % load('D:\Taiqi\Plyn_RF\Hafren_rain_pix_3\Final_step_Hafren_rain_pix_3_8783.mat')
            load([pwd filesep 'Hafren_rain_pix_3' filesep 'Final_step_Hafren_rain_pix_3_8783.mat']);
            t=2;
            TITLE_SAVE = 'Hafren_rain_pix_4';
            dateNum1 = datenum(2004, 10, 1, 0, 0, 0);
            dateNum2 = datenum(2005, 9, 30, 23, 0, 0);
