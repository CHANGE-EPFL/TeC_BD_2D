...
dateNum1 = datenum(2002, 10, 1, 0, 0, 0);
dateNum2 = datenum(2003, 9, 30, 23, 0, 0);
...
for t=2:N_time_step
    ...
    if t == 2
        ...
        if Opt_hot==1
            % load('D:\Taiqi\Plyn_RF\Hafren_rain_pix_1\Final_step_Hafren_rain_pix_1_8759.mat')
            load([pwd filesep 'Hafren_rain_pix_1' filesep 'Final_step_Hafren_rain_pix_1_8759.mat']);
            t=2;
            TITLE_SAVE = 'Hafren_rain_pix_2';
            dateNum1 = datenum(2002, 10, 1, 0, 0, 0);
            dateNum2 = datenum(2003, 9, 30, 23, 0, 0);
