...
for i = 1:N_nt
    fprintf(fid_BG(1), '%g\t', TR_exit(i));  % 36-42
end
for i = 1:N_nt-1
...
if  length(intersect(t,tstore))==1 ||  t==N_time_step
    ...
    save(Title_save_BG,...
        'P_spatial', 'LEAK_NH4_spatial', 'LEAK_NO3_spatial', 'LEAK_P_spatial', 'LEAK_K_spatial', 'LEAK_DON_spatial', 'LEAK_DOP_spatial','LEAK_DOC_spatial', ...
        'R_litter_spatial', 'R_microbe_spatial', 'R_litter_sur_spatial', 'R_ew_spatial', ...
        'VOL_spatial', 'N2flx_spatial', 'Min_N_spatial', 'Min_P_spatial', 'R_bacteria_spatial', 'RmycAM_spatial', 'RmycEM_spatial',...
        'Prod_B_spatial', 'Prod_F_spatial', 'BfixN_spatial', ...
...
for ipo=1:npoint
    ...
    fprintf(fid5_BG(1, ipo), '%g\t', NEE(ij)); % 28
    for i =1 :N_nt-1
        fprintf(fid5_BG(1, ipo), '%g\t', TRQexit(ipo,i)); % 29-34
    end
    fprintf(fid5_BG(1, ipo), '%g\t\n', TRQexit(ipo,N_nt)); % 35

    for k=1:54
        fprintf(fid5_BG_Pool(1,ipo), '%g\t', P(ij,k));
    end
