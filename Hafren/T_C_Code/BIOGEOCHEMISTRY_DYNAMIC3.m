...
NH4_in = 0.5*NMIN_IN;%0.90*NMIN_IN; %%% [gN/gsoil d] Mineralization - Immoblization NH4
NO3_in = 0.5*NMIN_IN;%0.10*NMIN_IN; %%% [gN/gsoil d]
...
%%%%%
S_DON = 0.01*B(33);%0.006*B(33); %% Stabilization DON
%%%%%%%%%%%%%%%%%%%%%%%%
%Phosphorus Fluxes
if CP_bac < R_CP_bac
    %%% Minerelazation
...
dB(31)=  Incoming_N + (1-f_org_lea)*Ip_lea_nit  +  NH4_in  - NO3flx  - NH4_Uptake - LEAK_NH4 - VOL + 0.9*Norg_imm;%0.9*Norg_imm;  %%% B31 Nitrogen Ione Ammonium NH4+
dB(32)=  NO3_in + NO3flx - NO3_Uptake - LEAK_NO3 - N2flx + 0.1*Norg_imm ;%0.1*Norg_imm ;%%% B32 Nitrogen Nitrate NO3-
