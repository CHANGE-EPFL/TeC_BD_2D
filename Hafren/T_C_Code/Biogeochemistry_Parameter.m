...
%%%%%%%%%%%%%%%%%%
%BiogeoPar.aK = 0.8; 
BiogeoPar.lambda_N=0.006; 
BiogeoPar.lambda_C=0.15;
BiogeoPar.aNH4 = 0.04; %% default 0.05
BiogeoPar.aDOC = 0.06; % increase DOC 
% BiogeoPar.fd =0.5;% 0.4; % [0.2-0.8]  fraction of decomposed P allocated to D
