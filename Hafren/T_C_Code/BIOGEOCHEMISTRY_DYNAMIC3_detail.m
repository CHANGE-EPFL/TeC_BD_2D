...
NH4_in = 0.5*NMIN_IN; %%% [gN/gsoil d] Mineralization - Immoblization NH4
NO3_in = 0.5*NMIN_IN; %%% [gN/gsoil d]
...
dB_flux(31,1:8)=[Incoming_N, + (1-f_org_lea)*Ip_lea_nit,  +  NH4_in,  - NO3flx,  - NH4_Uptake, - LEAK_NH4, - VOL, + 0.9*Norg_imm];
dB_flux(32,1:6)=[NO3_in, + NO3flx, - NO3_Uptake, - LEAK_NO3, - N2flx, + 0.1*Norg_imm];
