...
function[TR_sur,P,LEAK_nt,N_check,q_runon,q_channel_out,Qi_in,Slo_pot,Q_exit,Qsub_exit,...
    ...
    TR_exitS,...
    TRQexit,...
    T_pot,QpointH,QpointC,UpointH,UpointC,Utot_H,Utot_C]= ROUTING_MODULE_BG(N_nt,TR_I,TR_sur,QsurR,Asur,Ared,EG,If,Pr,P,Vtm1,LK,dt,dth,Rd,Rh,Qi_out,q_channel_in,...
...
% % % LK [mm]: water leakage
% % % TR_I [mm/g] : chemical concentration in the rain
...
Pr= Pr + QsurR; %%% [mm/h]  Precipitation
