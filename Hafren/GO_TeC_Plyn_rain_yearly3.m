...
dateNum1 = datenum(2003, 10, 1, 0, 0, 0);
dateNum2 = datenum(2004, 9, 30, 23, 0, 0);
...
for t=2:N_time_step
    ...
    if t == 2
        ...
        if Opt_hot==1
            % load('D:\Taiqi\Plyn_RF\Hafren_rain_pix_2\Final_step_Hafren_rain_pix_2_8759.mat')
            load([pwd filesep 'Hafren_rain_pix_2' filesep 'Final_step_Hafren_rain_pix_2_8759.mat']);
            t=2;
            TITLE_SAVE = 'Hafren_rain_pix_3';
            dateNum1 = datenum(2003, 10, 1, 0, 0, 0);
            dateNum2 = datenum(2004, 9, 30, 23, 0, 0);
