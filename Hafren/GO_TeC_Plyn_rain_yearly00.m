...
dateNum1 = datenum(2000, 1, 1, 0, 0, 0);
dateNum2 = datenum(2000, 9, 30, 23, 0, 0);
...
tstore=[40, 2160, 4320,6480,  8640];%8760;%87648;% 8760;%8766:8766:N_time_step;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%% GENERAL PARAMETER %%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
dt=3600; %%[s] %%%
